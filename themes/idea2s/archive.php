<?php get_header(); ?>
	<div class="narrowcolumn">
		...
		<?php else : ?>
		<div class="post"><h2><?php _e('Not Found', 'idea_domain'); ?></h2><div class="entry"><?php _e('You are looking for something which just is not here! Fear not however, errors are to be expected, and luckily there are tools on the sidebar for you to use in your search for what you need.', 'idea2s');?></div></div>
		<?php endif; ?>
